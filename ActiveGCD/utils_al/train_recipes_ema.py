...
def train_al_ema(student, student_ema, train_loader, al_labeled_loader, test_loader, unlabelled_train_loader,
    ...
    for epoch in range(args.epochs):
        ...
        # Step schedule
        exp_lr_scheduler.step()
        if all_acc_ema>best_all_acc_ema:
            best_all_acc_ema = all_acc_ema
            save_dict = {
        ...
        args.logger.info(f'Metrics with best model on train set: All: {best_all_acc:.4f} All_ema: {best_all_acc_ema:.4f}')
