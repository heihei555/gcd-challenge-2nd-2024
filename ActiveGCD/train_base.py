...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=0.100001)
    ...
    parser.add_argument('--sup_weight', type=float, default=0.33)
    ...
    parser.add_argument('--exp_name', default='cub_simgcd_base', type=str)
