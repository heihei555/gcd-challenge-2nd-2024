...
if __name__ == "__main__":
    ...
    # dataset labels NOTE!!!
    parser.add_argument('--prop_train_labels', type=float, default=0.2)
    ...
    parser.add_argument('--sup_weight', type=float, default=0.21)
    parser.add_argument('--n_views', default=2, type=int)

    parser.add_argument('--memax_weight', type=float, default=2)
    parser.add_argument('--warmup_teacher_temp', default=0.07, type=float, help='Initial value for the teacher temperature.')
    parser.add_argument('--teacher_temp', default=0.045, type=float, help='Final value (after linear warmup)of the teacher temperature.')
    ...
    # args for AL
    parser.add_argument('--strategy', type=str, default='NovelMarginSamplingAdaptive', help='Active Learning: strategy')
    parser.add_argument('--num_round', default=8, type=int, help='Active Learning: training rounds')
    ...
    parser.add_argument('--base_ckpts_date', type=str, default='20240824-032989', help='base (initial) checkpoints directories, e.g. 20231007-212237')
    parser.add_argument('--base_exp_id', default=None, type=str)
    parser.add_argument('--epochs', default=16, type=int, help='Active Learning training epochs per round')
    parser.add_argument('--al_batch_size', default=8, type=int, help='bathc size for AL labeled data')
    ...
    parser.add_argument('--exp_id', default='exp1', type=str)
    ...
    backbone = torch.hub.load('facebookresearch/dinov2', 'dinov2_viti14',pretrained=False)
    backbone_ema = torch.hub.load('facebookresearch/dinov2', 'dinov2_viti14',pretrained=False)
    ...
    model_ema = nn.Sequential(backbone_ema, projector_ema)

    ckpts = torch.load('/home/pod/shared-nvme/activeGCD/dev_outputs_al_ema_9rounds/scars/old98_ratio0.2_20240823-032999_query100/NovelMarginSamplingAdaptive_exp1/checkpoints/model_ema_round9.pt')
    ckpts = ckpts['model']
