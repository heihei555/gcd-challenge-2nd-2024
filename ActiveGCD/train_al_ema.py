...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_round', default=4, type=int, help='Active Learning: training rounds')
    ...
    parser.add_argument('--base_ckpts_date', type=str, default='20240824-032686', help='base (initial) checkpoints directories, e.g. 20231007-212237')
    parser.add_argument('--base_exp_id', default=None, type=str)
    parser.add_argument('--epochs', default=15, type=int, help='Active Learning training epochs per round')
    ...
    ckpts = torch.load('/home/pod/shared-nvme/activeGCD/dev_outputs_al_ema_8rounds/aircraft/old50_ratio0.2_20240823-032666_query100/NovelMarginSamplingAdaptive_exp1/checkpoints/model_round8.pt')
    ckpts = ckpts['model']
    model.load_state_dict(ckpts)
    print('Successfully load checkpoints.')
    model_ema.load_state_dict(ckpts)
