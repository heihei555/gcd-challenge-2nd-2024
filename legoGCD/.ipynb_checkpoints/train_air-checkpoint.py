...
if __name__ == "__main__":
    ...
    parser.add_argument('--warmup_model_dir', type=str, default='/home/pod/ZCC/legoGCD/dev_outputs/legogcd_cub/log/air_LegoGCD_(17.08.2024_|_59.059)/checkpoints/model.pt')
    parser.add_argument('--dataset_name', type=str, default='aircraft', help='options: cifar10, cifar100, imagenet_100, cub, scars, fgvc_aircraft, herbarium_19')
...
#     parser.add_argument('--sup_weight', type=float, default=0.35)
    ...
    parser.add_argument('--exp_name', default='air_LegoGCD', type=str)
