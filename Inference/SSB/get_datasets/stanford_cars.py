...
train_image_root = os.path.join(car_root, 'car_data', 'car_data', 'train')
test_image_root = os.path.join(car_root, 'car_data', 'car_data', 'test')

def get_scars_gcd_datasets(known_classes, 
    ...
    test_dataset = CustomImageFolder(root=test_image_root, transform=test_transform, dataset_name='scars')
